...
- **Interactive UDP target** -- The page lets you redirect FFmpeg UDP stream to any IP:port to verify L4 routing end-to-end.
...
1. Configure your proxy to forward a UDP port (e.g. `44444`) to the server UDP port (`22222`).
2. On the page, set the **IP** and **Port** fields to the proxy address/port and click **Send**.
